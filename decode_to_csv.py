...
if __name__=="__main__":
    ...
    listfile = os.listdir(r'G:\QAR_DATA\append_upload')
    for file in listfile:
        list_turn = decode_list.all_decode_list(r'G:\QAR_DATA\append_upload', file)
        csv_name = r'G:\QAR_DATA\CSV' + '\\' + file
        decode_list.save_to_csv(list_turn, csv_name)
